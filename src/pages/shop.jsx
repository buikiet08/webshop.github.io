...
function Shop() {
    ...
    const {data:product,loading:loadingProduct,error:errorProduct, paginate} = useQuery(() => productService.getproduct(`?page=${currentPage}`), [currentPage])
    console.log(product)
    return (
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-12 col-md-8 col-lg-9">
                        ...
                        {/* Products */}
                        <div className="row">
                           {!loadingProduct && product.map(e => (
                            <ProductCard key={e.id} name={e.name} {...e} />
                           ))}
                        </div>
                        {/* Pagination */}
